...
- `PGGAN`: Progressive Growing of GANs for Improved Quality, Stability, and Variation (ICLR 2018) : [arxiv](https://arxiv.org/abs/1710.10196), [review](https://happy-jihye.github.io/gan/gan-5/)
...
1. **Latent Optimization**
   ...
   - `BDInvert`: GAN Inversion for Out-of-Range Images with Geometric Transformations (ICCV 2021) : [arxiv](https://arxiv.org/abs/2108.08998), [review](https://happy-jihye.github.io/gan/gan-32), [code](https://github.com/kkang831/BDInvert_Release)
...
- `CDDFM3D`: Cross-Domain and Disentangled Face Manipulation with 3D Guidance (2021) : [arxiv](https://arxiv.org/abs/2104.11228), [code](https://github.com/cassiePython/cddfm3d), [project](https://cassiepython.github.io/sigasia/cddfm3d.html)
- `SofGAN`: A Portrait Image Generator with Dynamic Styling (arxiv 2021): [arxiv](https://arxiv.org/abs/2007.03780), [project](https://apchenstu.github.io/sofgan/), [code](https://github.com/apchenstu/sofgan), [review](https://happy-jihye.github.io/gan/gan-26/)
...
- Few-Shot Adversarial Learning of Realistic Neural Talking Head Models (ICCV 2019) : [arxiv](https://arxiv.org/abs/1905.08233), [review](https://happy-jihye.github.io/gan/gan-22/)
- `LPD`: Neural Head Reenactment with Latent Pose Descriptors (CVPR 2020) : [Paper](https://arxiv.org/abs/2004.12000), [review](https://happy-jihye.github.io/gan/gan-31/#lpd-neural-head-reenactment-with-latent-pose-descriptors-cvpr-2020), [project](https://saic-violet.github.io/latent-pose-reenactment/), [code](https://github.com/shrubb/latent-pose-reenactment)
- `Bi-layer model`: Fast Bi-layer Neural Synthesis of One-Shot Realistic Head Avatars (ECCV 2020): [arxiv](https://arxiv.org/abs/2008.10174), [review](https://happy-jihye.github.io/gan/gan-28/), [code](https://github.com/saic-violet/bilayer-model), [project](https://saic-violet.github.io/bilayer-model/)


<span style='background-color: #E5EBF7;'> **Warping-based Model** </span>

- `X2Face`: A network for controlling face generation by using images, audio, and pose codes (ECCV 2018) : [arxiv](https://arxiv.org/abs/1807.10550), [review](https://happy-jihye.github.io/gan/gan-29/#x2face-a-network-for-controlling-face-generation-by-using-images-audio-and-pose-codes-eccv-2018), [project](https://www.robots.ox.ac.uk/~vgg/research/unsup_learn_watch_faces/x2face.html)
- `Monkey-Net`: Animating Arbitrary Objects via Deep Motion Transfer (CVPR 2019) : [arxiv](https://arxiv.org/abs/1812.08861), [review](https://happy-jihye.github.io/gan/gan-29/#monkey-net-animation-arbitrary-objects-via-deep-motion-transfer-cvpr-2019), [project](http://www.stulyakov.com/papers/monkey-net.html), [code](https://github.com/AliaksandrSiarohin/monkey-net)
